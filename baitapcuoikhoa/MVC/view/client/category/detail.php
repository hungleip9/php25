  ...
  <div class="site-wrap">
    ...
    <div class="site-section">
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-md-6 col-lg-4 mb-5 text-center">
            <img src="<?php echo $category['image']?>" alt="Image" class="img-fluid w-50 rounded-circle mb-4">
    ...
    <div class="site-section bg-light">
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            <img src="<?php echo $category['image4']?>" alt="Image" class="img-fluid">
          </div>
