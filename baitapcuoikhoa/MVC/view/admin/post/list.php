        ...
        <div class="row">
          <div class="col-lg-12 mb-12">
            <div class="entry2" style="text-align: center;">
              <a href="single.html"><img style="width: 50%;" src="<?php echo $post['image'];?>" alt="Image" class="img-fluid rounded"></a>
              <div class="excerpt">
              ...
              <div class="post-meta align-items-center text-left clearfix">
                ...
                <button class="btn btn-primary" style="border-radius: 10px; margin-bottom: 20px;">Detail</button>
                <button class="btn btn-success" style="border-radius: 10px; margin-bottom: 20px;">Edit</button>
                <button class="btn btn-danger" style="border-radius: 10px; margin-bottom: 20px;">Delete</button>
              </div>
            </div>
          </div>          
        </div>
