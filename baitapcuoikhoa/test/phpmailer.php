<?php 
	function send_email($email,$name,$contents="Chào mừng bạn đã tham gia Blog Phim",$subject="Thành viên mới"){
        ...
        // To load the French version
            ...
            $mail->SetFrom("hungleip9@gmail.com", "Chào Mừng Bạn Đã Gia Nhập Vào Blog Phim"); // Thông tin người gửi
            $mail->AddReplyTo("hungleip9@gmail.com","Thành Viên Mới");// Ấn định email sẽ nhận khi người dùng reply lại.
